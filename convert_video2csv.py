...
if __name__ == "__main__":
    ...
    while cap.isOpened():
        ...
        if not success:
            ...
            #df_sum = pd.read_csv('./video_output' + new_name + new_num + '.csv')
            # print(df_sum)
            # print(experiment_df)
            #df_sum = pd.concat([df_sum, experiment_df])
            experiment_df.to_csv('./video_output/' + new_name + new_num + '.csv')
            print('Saved dataframe to : ', './video_output/' + new_name + new_num + '.csv')
            exit()
